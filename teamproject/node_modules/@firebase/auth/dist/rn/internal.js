...
var enum_maps = require('./enum_maps-31600c2a.js');
...
var BrowserPersistenceClass = /** @class */ (function () {
    ...
    BrowserPersistenceClass.prototype._isAvailable = function () {
        try {
            ...
            this.storage.setItem(enum_maps.STORAGE_AVAILABLE_KEY, '1');
            this.storage.removeItem(enum_maps.STORAGE_AVAILABLE_KEY);
...
function _iframeCannotSyncWebStorage() {
    var ua = util.getUA();
    return enum_maps._isSafari(ua) || enum_maps._isIOS(ua);
}
...
var BrowserLocalPersistence = /** @class */ (function (_super) {
    ...
    function BrowserLocalPersistence() {
        ...
        _this.safariLocalStorageNotSynced = _iframeCannotSyncWebStorage() && enum_maps._isIframe();
        // Whether to use polling instead of depending on window events
        _this.fallbackToPolling = enum_maps._isMobileBrowser();
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        db = _b.sent();
                        return [4 /*yield*/, _putObject(db, enum_maps.STORAGE_AVAILABLE_KEY, '1')];
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, _deleteObject(db, enum_maps.STORAGE_AVAILABLE_KEY)];
                    case 3:
                        _b.sent();
...
function startSignInPhoneMfa(auth, request) {
    return enum_maps._performApiRequest(auth, "POST" /* POST */, "/v2/accounts/mfaSignIn:start" /* START_PHONE_MFA_SIGN_IN */, tslib.__assign({ tenantId: auth.tenantId }, request));
}
function finalizeSignInPhoneMfa(auth, request) {
    return enum_maps._performApiRequest(auth, "POST" /* POST */, "/v2/accounts/mfaSignIn:finalize" /* FINALIZE_PHONE_MFA_SIGN_IN */, tslib.__assign({ tenantId: auth.tenantId }, request));
}
    ...
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    enum_maps._assert(session.type === "signin" /* SIGN_IN */, auth, "internal-error" /* INTERNAL_ERROR */);
                    mfaEnrollmentId = ((_a = phoneInfoOptions.multiFactorHint) === null || _a === void 0 ? void 0 : _a.uid) ||
                        phoneInfoOptions.multiFactorUid;
                    enum_maps._assert(mfaEnrollmentId, auth, "missing-multi-factor-info" /* MISSING_MFA_INFO */);
                ...
                case 7: return [4 /*yield*/, enum_maps.sendPhoneVerificationCode(auth, {
                        phoneNumber: phoneInfoOptions.phoneNumber,
                        recaptchaToken: recaptchaToken
                    })];
                case 8:
...
function _withDefaultResolver(auth, resolverOverride) {
    if (resolverOverride) {
        return enum_maps._getInstance(resolverOverride);
    }
    enum_maps._assert(auth._popupRedirectResolver, auth, "argument-error" /* ARGUMENT_ERROR */);
...
var IdpCredential = /** @class */ (function (_super) {
    ...
    IdpCredential.prototype._getIdTokenResponse = function (auth) {
        return enum_maps.signInWithIdp(auth, this._buildIdpRequest());
    };
    IdpCredential.prototype._linkToIdToken = function (auth, idToken) {
        return enum_maps.signInWithIdp(auth, this._buildIdpRequest(idToken));
    };
...
}(enum_maps.AuthCredential));
function _signIn(params) {
    return enum_maps._signInWithCredential(params.auth, new IdpCredential(params), params.bypassAuthState);
}
function _reauth(params) {
    var auth = params.auth, user = params.user;
    enum_maps._assert(user, auth, "internal-error" /* INTERNAL_ERROR */);
    return enum_maps._reauthenticate(user, new IdpCredential(params), params.bypassAuthState);
}
function _link(params) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_a) {
            ...
            enum_maps._assert(user, auth, "internal-error" /* INTERNAL_ERROR */);
            return [2 /*return*/, enum_maps._link(user, new IdpCredential(params), params.bypassAuthState)];
        });
    });
}
    ...
    AbstractPopupRedirectOperation.prototype.getIdpTask = function (type) {
        switch (type) {
            ...
            case "reauthViaRedirect" /* REAUTH_VIA_REDIRECT */:
                return _reauth;
            default:
                enum_maps._fail(this.auth, "internal-error" /* INTERNAL_ERROR */);
        }
    };
    AbstractPopupRedirectOperation.prototype.resolve = function (cred) {
        enum_maps.debugAssert(this.pendingPromise, 'Pending promise was never set');
 ...
 * limitations under the License.
 */
var _POLL_WINDOW_CLOSE_TIMEOUT = new enum_maps.Delay(2000, 10000);
/**
...
function signInWithPopup(auth, provider, resolver) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_a) {
            authInternal = enum_maps._castAuth(auth);
            enum_maps._assert(provider instanceof enum_maps.FederatedAuthProvider, auth, "argument-error" /* ARGUMENT_ERROR */);
...
function reauthenticateWithPopup(user, provider, resolver) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_a) {
            userInternal = util.getModularInstance(user);
            enum_maps._assert(provider instanceof enum_maps.FederatedAuthProvider, userInternal.auth, "argument-error" /* ARGUMENT_ERROR */);
...
var PopupOperation = /** @class */ (function (_super) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        enum_maps._assert(result, this.auth, "internal-error" /* INTERNAL_ERROR */);
    ...
    PopupOperation.prototype.onExecution = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        enum_maps.debugAssert(this.filter.length === 1, 'Popup operations only handle one event');
                    ...
                    case 1:
                        ...
                        this.resolver._isIframeWebStorageSupported(this.auth, function (isSupported) {
                            if (!isSupported) {
                                _this.reject(enum_maps._createError(_this.auth, "web-storage-unsupported" /* WEB_STORAGE_UNSUPPORTED */));
                            }
                        });
    ...
    PopupOperation.prototype.cancel = function () {
        this.reject(enum_maps._createError(this.auth, "cancelled-popup-request" /* EXPIRED_POPUP_REQUEST */));
    };
        ...
        var poll = function () {
            ...
            if ((_b = (_a = _this.authWindow) === null || _a === void 0 ? void 0 : _a.window) === null || _b === void 0 ? void 0 : _b.closed) {
                ...
                _this.pollId = window.setTimeout(function () {
                    _this.pollId = null;
                    _this.reject(enum_maps._createError(_this.auth, "popup-closed-by-user" /* POPUP_CLOSED_BY_USER */));
                }, 2000 /* AUTH_EVENT */);
                return;
            }
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 7:
                        ...
                        _b.label = 8;
                    case 8: return [2 /*return*/, readyOutcome()];
                }
            });
        });
    };
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, resolverPersistence(resolver)._get(key)];
                case 1:
                    hasPendingRedirect = (_a.sent()) === 'true';
                    return [4 /*yield*/, resolverPersistence(resolver)._remove(key)];
                case 2:
                    _a.sent();
...
function resolverPersistence(resolver) {
    return enum_maps._getInstance(resolver._redirectPersistence);
}
function pendingRedirectKey(auth) {
    return enum_maps._persistenceKeyName(PENDING_REDIRECT_KEY, auth.config.apiKey, auth.name);
}
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    enum_maps._assert(provider instanceof enum_maps.FederatedAuthProvider, userInternal.auth, "argument-error" /* ARGUMENT_ERROR */);
                    resolverInternal = _withDefaultResolver(userInternal.auth, resolver);
                    return [4 /*yield*/, enum_maps._assertLinkedStatus(false, userInternal, provider.providerId)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, _setPendingRedirectStatus(resolverInternal, userInternal.auth)];
                case 2:
...
function getRedirectResult(auth, resolver) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, enum_maps._castAuth(auth)._initializationPromise];
                case 1:
                    _a.sent();
...
var AuthEventManager = /** @class */ (function () {
    ...
    AuthEventManager.prototype.sendToConsumer = function (event, consumer) {
        ...
        if (event.error && !isNullRedirectEvent(event)) {
            ...
            consumer.onError(enum_maps._createError(this.auth, code));
        }
        else {
...
function _getProjectConfig(auth, request) {
    ...
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_a) {
            return [2 /*return*/, enum_maps._performApiRequest(auth, "GET" /* GET */, "/v1/projects" /* GET_PROJECT_CONFIG */, request)];
        });
    });
}
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    enum_maps._fail(auth, "unauthorized-domain" /* INVALID_ORIGIN */);
                    return [2 /*return*/];
            }
        });
    });
...
function matchDomain(expected) {
    var currentUrl = enum_maps._getCurrentUrl();
 ...
 * limitations under the License.
 */
var NETWORK_TIMEOUT = new enum_maps.Delay(30000, 60000);
/**
 ...
 * limitations under the License.
 */
var PING_TIMEOUT = new enum_maps.Delay(5000, 15000);
...
function getIframeUrl(auth) {
    ...
    enum_maps._assert(config.authDomain, auth, "auth-domain-config-required" /* MISSING_AUTH_DOMAIN */);
    var url = config.emulator
        ? enum_maps._emulatorUrl(config, EMULATED_IFRAME_PATH)
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    context = _a.sent();
                    gapi = _window().gapi;
                    enum_maps._assert(gapi, auth, "internal-error" /* INTERNAL_ERROR */);
                            ...
                            return new Promise(function (resolve, reject) { return tslib.__awaiter(_this, void 0, void 0, function () {
                                ...
                                return tslib.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            _a.sent();
                                            networkError = enum_maps._createError(auth, "network-request-failed" /* NETWORK_REQUEST_FAILED */);
...
function _open(auth, url, name, width, height) {
    ...
    if (name) {
        target = enum_maps._isChromeIOS(ua) ? TARGET_BLANK : name;
    }
    if (enum_maps._isFirefox(ua)) {
    ...
    if (enum_maps._isIOSStandalone(ua) && target !== '_self') {
    ...
    enum_maps._assert(newWin, auth, "popup-blocked" /* POPUP_BLOCKED */);
...
function _getRedirectUrl(auth, provider, authType, redirectUrl, eventId, additionalParams) {
    enum_maps._assert(auth.config.authDomain, auth, "auth-domain-config-required" /* MISSING_AUTH_DOMAIN */);
    enum_maps._assert(auth.config.apiKey, auth, "invalid-api-key" /* INVALID_API_KEY */);
    var params = {
    ...
    if (provider instanceof enum_maps.FederatedAuthProvider) {
    ...
    if (provider instanceof enum_maps.BaseOAuthProvider) {
...
function getHandlerBase(_a) {
    ...
    return enum_maps._emulatorUrl(config, EMULATOR_WIDGET_PATH);
}
...
var BrowserPopupRedirectResolver = /** @class */ (function () {
    ...
    BrowserPopupRedirectResolver.prototype._openPopup = function (auth, provider, authType, eventId) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            var url;
            return tslib.__generator(this, function (_b) {
                enum_maps.debugAssert((_a = this.eventManagers[auth._key()]) === null || _a === void 0 ? void 0 : _a.manager, '_initialize() not called before _openPopup()');
                url = _getRedirectUrl(auth, provider, authType, enum_maps._getCurrentUrl(), eventId);
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _setWindowLocation(_getRedirectUrl(auth, provider, authType, enum_maps._getCurrentUrl(), eventId));
    ...
    BrowserPopupRedirectResolver.prototype._initialize = function (auth) {
        ...
        if (this.eventManagers[key]) {
            ...
            if (manager) {
                ...
                enum_maps.debugAssert(promise_1, 'If manager is not set, promise should be');
                return promise_1;
            }
        }
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        iframe.register('authEvent', function (iframeEvent) {
                            enum_maps._assert(iframeEvent === null || iframeEvent === void 0 ? void 0 : iframeEvent.authEvent, auth, "invalid-auth-event" /* INVALID_AUTH_EVENT */);
    ...
    BrowserPopupRedirectResolver.prototype._isIframeWebStorageSupported = function (auth, cb) {
        ...
        iframe.send(WEB_STORAGE_SUPPORT_KEY, { type: WEB_STORAGE_SUPPORT_KEY }, function (result) {
            ...
            enum_maps._fail(auth, "internal-error" /* INTERNAL_ERROR */);
        }, gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER);
    };
    ...
    Object.defineProperty(BrowserPopupRedirectResolver.prototype, "_shouldInitProactively", {
        get: function () {
            ...
            return enum_maps._isMobileBrowser() || enum_maps._isSafari() || enum_maps._isIOS();
        },
        enumerable: false,
        configurable: true
    });
...
enum_maps.registerAuth("Browser" /* BROWSER */);
        ...
        return tslib.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    enum_maps.debugAssert(event.sessionId, 'AuthEvent did not contain a session ID');
                ...
                case 1:
                    ...
                    else if (enum_maps._isAndroid()) {
                        // Android app identifier
                        additionalParams['apn'] = BuildInfo.packageName;
                    }
                    else {
                        enum_maps._fail(auth, "operation-not-supported-in-this-environment" /* OPERATION_NOT_SUPPORTED */);
                    }
    ...
    return new Promise(function (resolve) {
        cordova.plugins.browsertab.isAvailable(function (browserTabIsAvailable) {
            ...
            if (browserTabIsAvailable) {
                ...
                iabRef = cordova.InAppBrowser.open(handlerUrl, enum_maps._isIOS7Or8() ? '_blank' : '_system', 'location=yes');
            }
            resolve(iabRef);
        });
    });
                    ...
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            ...
                            function resumed() {
                                ...
                                onCloseTimer = window.setTimeout(function () {
                                    ...
                                    reject(enum_maps._createError(auth, "redirect-cancelled-by-user" /* REDIRECT_CANCELLED_BY_USER */));
                                }, REDIRECT_TIMEOUT_MS);
                            }
...
function _checkCordovaConfiguration(auth) {
    ...
    enum_maps._assert(typeof ((_a = win === null || win === void 0 ? void 0 : win.universalLinks) === null || _a === void 0 ? void 0 : _a.subscribe) === 'function', auth, "invalid-cordova-configuration" /* INVALID_CORDOVA_CONFIGURATION */, {
        missingPlugin: 'cordova-universal-links-plugin-fix'
    });
    // https://www.npmjs.com/package/cordova-plugin-buildinfo
    enum_maps._assert(typeof ((_b = win === null || win === void 0 ? void 0 : win.BuildInfo) === null || _b === void 0 ? void 0 : _b.packageName) !== 'undefined', auth, "invalid-cordova-configuration" /* INVALID_CORDOVA_CONFIGURATION */, {
        missingPlugin: 'cordova-plugin-buildInfo'
    });
    // https://github.com/google/cordova-plugin-browsertab
    enum_maps._assert(typeof ((_e = (_d = (_c = win === null || win === void 0 ? void 0 : win.cordova) === null || _c === void 0 ? void 0 : _c.plugins) === null || _d === void 0 ? void 0 : _d.browsertab) === null || _e === void 0 ? void 0 : _e.openUrl) === 'function', auth, "invalid-cordova-configuration" /* INVALID_CORDOVA_CONFIGURATION */, {
        missingPlugin: 'cordova-plugin-browsertab'
    });
    enum_maps._assert(typeof ((_h = (_g = (_f = win === null || win === void 0 ? void 0 : win.cordova) === null || _f === void 0 ? void 0 : _f.plugins) === null || _g === void 0 ? void 0 : _g.browsertab) === null || _h === void 0 ? void 0 : _h.isAvailable) === 'function', auth, "invalid-cordova-configuration" /* INVALID_CORDOVA_CONFIGURATION */, {
        missingPlugin: 'cordova-plugin-browsertab'
    });
    // https://cordova.apache.org/docs/en/latest/reference/cordova-plugin-inappbrowser/
    enum_maps._assert(typeof ((_k = (_j = win === null || win === void 0 ? void 0 : win.cordova) === null || _j === void 0 ? void 0 : _j.InAppBrowser) === null || _k === void 0 ? void 0 : _k.open) === 'function', auth, "invalid-cordova-configuration" /* INVALID_CORDOVA_CONFIGURATION */, {
...
function stringToArrayBuffer(str) {
    ...
    enum_maps.debugAssert(/[0-9a-zA-Z]+/.test(str), 'Can only convert alpha-numeric strings');
...
function _generateNewEvent(auth, type, eventId) {
    ...
    return {
        ...
        error: enum_maps._createError(auth, "no-auth-event" /* NO_AUTH_EVENT */)
    };
}
...
function _eventFromPartialAndUrl(partialEvent, url) {
    ...
    if (callbackUrl.includes('/__/auth/callback')) {
        ...
        var error = code ? enum_maps._createError(code) : null;
        if (error) {
            return {
...
function storage() {
    return enum_maps._getInstance(browserLocalPersistence);
}
function persistenceKey(auth) {
    return enum_maps._persistenceKeyName("authEvent" /* AUTH_EVENT */, auth.config.apiKey, auth.name);
}
...
function generateNoEvent() {
    return {
        ...
        postBody: null,
        tenantId: null,
        error: enum_maps._createError("no-auth-event" /* NO_AUTH_EVENT */)
    };
}
...
function addFrameworkForLogging(auth, framework) {
    enum_maps._castAuth(auth)._logFramework(framework);
}
...
exports.AuthImpl = enum_maps.AuthImpl;
...
exports.FetchProvider = enum_maps.FetchProvider;
...
exports.SAMLAuthCredential = enum_maps.SAMLAuthCredential;
...
exports.UserImpl = enum_maps.UserImpl;
exports._assert = enum_maps._assert;
exports._castAuth = enum_maps._castAuth;
exports._fail = enum_maps._fail;
exports._getClientVersion = enum_maps._getClientVersion;
exports._getInstance = enum_maps._getInstance;
exports._persistenceKeyName = enum_maps._persistenceKeyName;
